...
Route::middleware( 'auth:admin' )->name( 'admin.' )->prefix( 'admin' )->group( function () {
    ...
    Route::get( 'countries/fetch-items', [ CountryController::class, 'fetchItems' ] )->name( 'countries.fetch_items' );
    Route::resource( 'countries', CountryController::class );
    Route::post( '/countries/order', [ CountryController::class, 'order' ] )->name( 'countries.order' );
    Route::get( 'countries-regions/fetch-items/{country}', [ RegionController::class, 'fetchItems' ] )->name( 'countries.regions.fetch_items' );
    ...
    Route::get( 'countries-regions-cities/fetch-items/{region}', [ RegionCityController::class, 'fetchItems' ] )->name( 'countries.regions.cities.fetch_items' );
